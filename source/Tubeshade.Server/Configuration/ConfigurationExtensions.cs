...
{
    internal static bool GetValidIfDefined<
        [MeansImplicitUse(Assign, Members)] [DynamicallyAccessedMembers(All)] TOptions>(
    ...
    [UnconditionalSuppressMessage("Trimming", "IL2026",
        Justification = $"{nameof(DynamicallyAccessedMembersAttribute)} indicates what is dynamically accessed")]
    internal static TOptions GetValid<[MeansImplicitUse(Assign, Members)] [DynamicallyAccessedMembers(All)] TOptions>(
        this IConfiguration configuration,
        string sectionName)
        where TOptions : notnull, new()
