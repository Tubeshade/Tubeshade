...
using Tubeshade.Server.Pages.Playlists;
using Tubeshade.Server.Pages.Shared;

namespace Tubeshade.Server.Pages.Libraries.Playlists;

public sealed class Index : LibraryPageBase, IPlaylistPage
{
    ...
    public async Task<IActionResult> OnGet(CancellationToken cancellationToken)
    {
        ...
        var parameters = this.GetPlaylistParameters(userId, LibraryId);
