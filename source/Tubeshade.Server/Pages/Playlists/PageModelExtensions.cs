...
public static class PageModelExtensions
{
    ...
    public static VideoParameters GetVideoParameters<TPage>(
        ...
        Guid userId,
        Guid playlistId)
        where TPage : PageModel, IPlaylistVideoPage
    {
        pageModel.ApplyDefaultFilters(pageModel);
        ...
        return new()
        {
            ...
            SortBy = pageModel.SortBy ?? Defaults.PlaylistVideoOrder,
            SortDirection = pageModel.SortDirection ?? Defaults.PlaylistVideoDirection,
        };
    }
}
